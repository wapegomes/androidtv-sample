 ...
 */
package com.sample.wapegomes.androidtv.data;
...
public class VideoDbBuilder {
    ...
    public static final String TAG_GOOGLE_VIDEOS = "videolists";
    ...
    public List<ContentValues> buildMedia(JSONObject jsonObj) throws JSONException {
        ...
        for (int i = 0; i < categoryArray.length(); i++) {
            ...
            for (int j = 0; j < videoArray.length(); j++) {
                ...
                String videoUrl = PREFIX_URL + urls.get(0); // Get the first video only.
                String bgImageUrl = PREFIX_URL + video.getString(TAG_BACKGROUND);
                String cardImageUrl = PREFIX_URL + video.getString(TAG_CARD_THUMB);
