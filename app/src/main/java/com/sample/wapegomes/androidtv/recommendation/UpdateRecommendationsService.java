...
package com.sample.wapegomes.androidtv.recommendation;
...
import com.sample.wapegomes.androidtv.BuildConfig;
...
import com.sample.wapegomes.androidtv.ui.VideoDetailsActivity;
...
public class UpdateRecommendationsService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        ContentRecommendation.Builder builder = new ContentRecommendation.Builder()
                .setBadgeIcon(R.drawable.digital_day);
