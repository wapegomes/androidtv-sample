...
package com.sample.wapegomes.androidtv.ui;
...
import com.sample.wapegomes.androidtv.data.FetchVideoService;
import com.sample.wapegomes.androidtv.data.VideoContract;
import com.sample.wapegomes.androidtv.model.Video;
import com.sample.wapegomes.androidtv.model.VideoCursorMapper;
import com.sample.wapegomes.androidtv.presenter.CardPresenter;
import com.sample.wapegomes.androidtv.presenter.GridItemPresenter;
import com.sample.wapegomes.androidtv.presenter.IconHeaderItemPresenter;
import com.sample.wapegomes.androidtv.recommendation.UpdateRecommendationsService;
...
public class MainFragment extends BrowseFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void setupUIElements() {
        setBadgeDrawable(
                getActivity().getResources().getDrawable(R.drawable.digital_day, null));
